...
def instructions():
  ...
  print()
  print("You only have 1-10 rounds to play the this game, each round you will spend $1.")
  print()
  print("From each round you will get a donkey, a zebra, a horse and a unicorn.")
  print()
...
if played_before == "yes":
  instructions()
print()
statement_generator("Lucky Unicorn Game Continues", "~")
print()
